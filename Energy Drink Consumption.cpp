...
int main()
{
	...
	// Display the results
	cout << “The number of customers who buy one or more energy drinks per week is “ << oneOrMore << "/n";
	cout << “The number of customers who prefer citris flaovered energy drinks is” << preferCitris << "/n";
	return 0;
}